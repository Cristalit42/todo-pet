'use strict'
// function textEdit() {
//   let editBtn = document.getElementById('element').querySelector('.element-edit'),
//     elementText = document.getElementById('element').querySelector('.element-text').innerHTML.trim();
...
//     if (textInput) {
//       document.getElementById('element').querySelector('.element-text').innerHTML = textInput;
//     } else {
//       document.getElementById('element').querySelector('.element-text').innerHTML = elementText;
//     }
//   })
// }
