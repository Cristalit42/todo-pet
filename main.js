'use strict'
function textEdit() {
  let editBtn = document.getElementById('element-1').querySelector('.element-edit'),
    elementText = document.getElementById('element-1').querySelector('.element-text').innerHTML.trim();
  ...
  editBtn.addEventListener('click', function (event) {
    ...
    if (textInput) {
      document.getElementById('element-1').querySelector('.element-text').innerHTML = textInput;
    } else {
      document.getElementById('element-1').querySelector('.element-text').innerHTML = elementText;
    }
  })
}
